...
namespace QTM2Unity
{
    ...
    class RTCharacerStream : RTSkeleton
    {
        ...
        {
            localRotation = Quaternion.Euler(debug.jointsRot.root) * transform.gameObject.transform.rotation;
            SetAll();
        }
        ...
        private void SetAll()
        {
            foreach (var b in skeleton.Root)
            {
                ...
                {
                    case Joint.PELVIS:
                        setGO(charactersJoints.pelvis, b.Data, setPos: true);
                        break;
                    case Joint.SPINE0:
                        if (charactersJoints.spine.Length > 0)
                            setGO(charactersJoints.spine[0], b.Data);
                        break;
                    case Joint.SPINE1:
                        if (charactersJoints.spine.Length > 1)
                            setGO(charactersJoints.spine[1], b.Data);
                        break;
                    case Joint.SPINE3:
                        if (charactersJoints.spine.Length > 2)
                            setGO(charactersJoints.spine[2], b.Data);                        
                        break;
                    case Joint.NECK:
                        setGO(charactersJoints.neck, b.Data);
                        break;
                    case Joint.HEAD:
                        setGO(charactersJoints.head, b.Data);
                        break;
                    case Joint.HIP_L:
                        setGO(charactersJoints.leftThigh, b.Data, debug.jointsRot.leg);
                        break;
                    case Joint.HIP_R:
                        setGO(charactersJoints.rightThigh, b.Data, debug.jointsRot.leg);
                        break;
                    case Joint.KNEE_L:
                        setGO(charactersJoints.leftCalf, b.Data, debug.jointsRot.leg);
                        break;
                    case Joint.KNEE_R:
                        setGO(charactersJoints.rightCalf, b.Data, debug.jointsRot.leg);
                        break;
                    case Joint.FOOTBASE_L:
                        setGO(charactersJoints.leftFoot, b.Data, debug.jointsRot.feet);
                        break;
                    case Joint.FOOTBASE_R:
                        setGO(charactersJoints.rightFoot, b.Data, debug.jointsRot.feet);
                        break;
                    case Joint.CLAVICLE_L:
                        setGO(charactersJoints.shoulderLeft, b.Data, debug.jointsRot.armLeft);
                        break;
                    case Joint.CLAVICLE_R:
                        setGO(charactersJoints.shoulderRight, b.Data, debug.jointsRot.armRight);
                        break;
                    case Joint.SHOULDER_L:
                        setGO(charactersJoints.leftUpperArm, b.Data, debug.jointsRot.armLeft);
                        break;
                    case Joint.SHOULDER_R:
                        setGO(charactersJoints.rightUpperArm, b.Data, debug.jointsRot.armRight);
                        break;
                    case Joint.ELBOW_L:
                        setGO(charactersJoints.leftForearm, b.Data, debug.jointsRot.armLeft);
                        break;
                    case Joint.ELBOW_R:
                        setGO(charactersJoints.rightForearm, b.Data, debug.jointsRot.armRight);
                        break;
                    case Joint.WRIST_L:
                    ...
                    case Joint.HAND_L:
                        if (debug.jointsRot.UseFingers) 
                            foreach (var fing in charactersJoints.fingersLeft) 
                                setGO(fing, b.Data, debug.jointsRot.handLeft);
                        break;
                    case Joint.HAND_R:
                        if (debug.jointsRot.UseFingers) 
                            foreach (var fing in charactersJoints.fingersRight) 
                                setGO(fing, b.Data, debug.jointsRot.handRight);
                        break;
                    case Joint.TRAP_L:
                        if (debug.jointsRot.UseFingers) 
