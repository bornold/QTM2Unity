...
namespace QTMRealTimeSDK.Network
{
    public class RTNetwork
    {
        ...
        public int receive(ref byte[] receivebuffer, bool onlyTCP = false, int timeout = 1000000)
        {
        ...
        public bool send(byte[] sendBuffer, int bufferSize)
        {
            int sentData = 0;
        ...
        /// <returns></returns>
        public bool sendUDPBroadcast(byte[] sendBuffer, int bufferSize, int discoverPort = RTProtocol.Constants.STANDARD_BROADCAST_PORT )
        {
            if (mUDPBroadcastClient != null)
            {
                try
        ...
        /// <summary>
        /// Error string related to errors that could have occured during execution of commands
        /// </summary>
        ...
        /// <summary>
        /// More specific error related to socket error occured during execution of commands.
        /// </summary>
